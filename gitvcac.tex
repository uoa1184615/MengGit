...
\item Checking and downloading, `pulling', any changes by your collaborators is one additional step you might like to do before starting work each session: from menu \texttt{Repository} select \texttt{Pull}.
\end{itemize}
\end{github}
