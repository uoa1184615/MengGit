...
uu(1,j)=gam*(uu(imid,jp)+uu(imid,jm))/2 ...
           ...
           +(9-10*r^2+r^4)*gam^3*(uu(imid,jppp)+uu(imid,jpp) ...
               -2*uu(imid,jp)-2*uu(imid,jm)+uu(imid,jmm) ...
                +uu(imid,jmmm))/768 ...
           +(9*r-10*r^3+r^5)*gam^3*(uu(imid,jppp)-5*uu(imid,jpp) ...
                +10*uu(imid,jp)-10*uu(imid,jm)+5*uu(imid,jmm) ...
                -uu(imid,jmmm))/3840;
...
% nonlinear terms
dhudt(i1,j0)=dhudt(i1,j0)-c1*uu(i1,j0).*(uu(i1+2,j0) ...
                  -uu(i1-2,j0))/2/dx+c2*g*sin(theta);
uux=uu(i0(1:end-2),j1)-uu(i0(3:end),j1);
dhudt(i0,j1)=dhudt(i0,j1)-c1/2/dx*uu(i0,j1).*[uux(1,:);uux;uux(end,:)] ...
                  +c2*g*sin(theta);
