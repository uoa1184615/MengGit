...
\begin{enumerate}
\item If~$\cos\ell=0$\,, then~$\ell=\pi/2,3\pi/2,5\pi/2,\ldots$ for all coupling~$\gamma$. \marginpar{Need some interpretation.}
\item If~$(2-\gamma)\sin\ell+\gamma\sin\ell\cos2k\pm\gamma\sin2k=0$\,, 
in the decoupled case, $\gamma=0$\,, obtain~$\sin\ell=0$, which indicates~$\ell=0,\pi,2\pi,\ldots$.  \marginpar{Need some interpretation.}
